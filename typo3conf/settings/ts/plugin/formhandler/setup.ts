plugin.Tx_Formhandler.settings.predef.formhandler-basic-contactform {
	...
	langFile.1 = TEXT
	langFile.1.value = {$formhandler.basic.contact-form.rootPath}/lang/lang.xml

	templateFile = TEXT
	templateFile.value = {$formhandler.basic.contact-form.rootPath}/html/step-1.html
	...
	masterTemplateFile.value = {$formhandler.basic.contact-form.rootPath}/html/mastertemplate.html

	# If you use YAML, you don't need to include 1&2
	cssFile {
		10 = TEXT
		10.value = {$formhandler.basic.contact-form.rootPath}/skin/css/base.css
		20 = TEXT
		20.value = {$formhandler.basic.contact-form.rootPath}/skin/css/forms.css
		25 = TEXT
		25.value = {$formhandler.basic.contact-form.rootPath}/skin/css/special.css
		30 = TEXT
		30.value = {$formhandler.basic.contact-form.rootPath}/skin/css/colors.css
	}
	...
	finishers {
		...
		1.config {
			...
			admin {
				templateFile = TEXT
				templateFile.value = {$formhandler.basic.contact-form.rootPath}/html/email-admin.html
				sender_email = {$formhandler.basic.contact-form.email.admin.sender_email}
				to_email = {$formhandler.basic.contact-form.email.admin.to_email}
				subject = TEXT
				subject.data = LLL:{$formhandler.basic.contact-form.rootPath}/lang/lang.xml:email_admin_subject
			}
		}
		...
		5.config {
			redirectPage = {$formhandler.basic.contact-form.redirectPage}
		}
	}
...
plugin.Tx_Formhandler.settings.predef.formhandler-basic-contactform {
	finishers {
		1.config {
			user {
				templateFile = TEXT
				templateFile.value = {$formhandler.basic.contact-form.rootPath}/html/email-user.html
				sender_email = {$formhandler.basic.contact-form.email.user.sender_email}
				to_email = email
				subject = TEXT
				subject.data = LLL:{$formhandler.basic.contact-form.rootPath}/lang/lang.xml:email_user_subject
			}
		}
	}
}
